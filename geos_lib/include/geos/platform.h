...
const double DoubleNotANumber = std::numeric_limits<double>::quiet_NaN();
const double DoubleMax = (std::numeric_limits<double>::max)();
const double DoubleInfinity = (std::numeric_limits<double>::infinity)();
const double DoubleNegInfinity = (-(std::numeric_limits<double>::infinity)());
